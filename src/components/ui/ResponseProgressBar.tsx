...
export const ResponseProgressBar: React.FC<ResponseProgressBarProps> = ({
  ...
  return (
    <div
      className={`max-w-[70%] sm:max-w-[280px] lg:max-w-[320px] xl:max-w-[360px] mx-auto ${className}`}
    >
      ...
      {currentTip && (
        <div className="text-xs text-red-700 dark:text-amber-400 text-center font-medium leading-relaxed">
          {currentTip}
        </div>
      )}
    </div>
